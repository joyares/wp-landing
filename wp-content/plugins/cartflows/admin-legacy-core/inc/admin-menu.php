...
use CartflowsAdmin\AdminLegacyCore\Inc\AdminHelper;
use CartflowsAdmin\AdminLegacyCore\Inc\LogStatus;
	...
	public function styles_scripts() {
		...
		$localize = apply_filters(
			...
			array(
				...
				'image_placeholder'                 => esc_url_raw( CARTFLOWS_URL . 'admin-legacy-core/assets/images/image-placeholder.png' ),
				...
				'switch_ui_notice'                  => array(
					...
					// + per-user dismissal — same gating the AJAX endpoints check.
					'visible'        => \Cartflows_Admin_Notices::get_instance()->is_new_ui_notice_visible(),
					'switch_action'  => 'cartflows_switch_to_new_ui',
					'switch_nonce'   => wp_create_nonce( 'cartflows_switch_to_new_ui' ),
					'dismiss_action' => 'cartflows_dismiss_new_ui_notice',
					'dismiss_nonce'  => wp_create_nonce( 'cartflows_dismiss_new_ui_notice' ),
				),
			)
		);
