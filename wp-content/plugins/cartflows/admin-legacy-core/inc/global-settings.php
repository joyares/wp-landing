					...
					'page_builder'              => array(
						...
						'options' => array(
							array(
								...
								'image' => esc_url_raw( CARTFLOWS_URL . 'admin-legacy-core/assets/images/page-builders/block-editor.png' ),
							),
							array(
								'value' => 'elementor',
								'label' => __( 'Elementor', 'cartflows' ),
								'image' => esc_url_raw( CARTFLOWS_URL . 'admin-legacy-core/assets/images/page-builders/elementor.svg' ),
							),
							array(
								'value' => 'bricks-builder',
								'label' => __( 'Bricks', 'cartflows' ),
								'image' => esc_url_raw( CARTFLOWS_URL . 'admin-legacy-core/assets/images/page-builders/bricks.png' ),
							),
							array(
								'value' => 'beaver-builder',
								'label' => __( 'Beaver', 'cartflows' ),
								'image' => esc_url_raw( CARTFLOWS_URL . 'admin-legacy-core/assets/images/page-builders/beaver-builder.svg' ),
							),
							array(
								'value' => 'other',
								'label' => __( 'Other', 'cartflows' ),
								'image' => esc_url_raw( CARTFLOWS_URL . 'admin-legacy-core/assets/images/page-builders/other.svg' ),
							),
						),
